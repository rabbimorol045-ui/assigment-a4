...
Ans: getElementById:selected one element by id and also return single element .
...
Ans: const h1Find = documents.getElement('h1');
...
Ans: Event bubbleing means a event starts from targetelement and bubbles up parent element.




4. What is Event Delegation in JavaScript? Why is it useful?
Ans: Event delegation means adding a event listener to a parent elemnr handle aevents child parent .
